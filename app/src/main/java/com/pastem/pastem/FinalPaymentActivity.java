...
public class FinalPaymentActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finalPaymentBtn =findViewById(R.id.final_payment_btn);
    ...
    private void getPayment() {
        ...
        PayPalPayment payment = new PayPalPayment(new BigDecimal(String.valueOf(paymentAmount)), "USD", "Final Payment",
